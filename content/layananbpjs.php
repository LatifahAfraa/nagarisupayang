        ...
        <div class="container-fluid h-100">
            <div class="row h-10 align-items-center">
                <div class="col-12 col-lg-8 mx-auto">
                    ...
                    <div class="post-content text-center my-5">
                        <p class="post-title" style="font-size: 44px;">Layanan BPJS Mandiri Nagari Supayang</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="overviews" class="section wb">
                    <div class="container">
                        <div class="row"> 
                        <?php 			
    $result = mysqli_query($kon, "SELECT * FROM `tb_layanan` WHERE jenis='LAYANAN BPJS MANDIRI' AND judul != '' AND judul IS NOT NULL");
    if(mysqli_num_rows($result) == 0) {
        echo "<h4>*Data Layanan BPJS Mandiri Belum Ada*</h4>";
    } else {
