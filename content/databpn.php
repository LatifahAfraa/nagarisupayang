...
<div class="post-details-title-area bg-overlay clearfix" style="background-image: url(img/bg-img/88.jpg); height: 16em">
            ...
            <div class="row h-10 align-items-center">
                <div class="col-12 col-lg-8 mx-auto">
                    ...
                    <div class="post-content text-center my-5">
                        <p class="post-title" style="font-size: 44px;">Data BPN Dan Anggota</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php 			
    $result = mysqli_query($kon,"SELECT * FROM tb_data where jenis = 'DATA BPN DAN ANGGOTA'");
	$data = mysqli_fetch_array($result);

    
?>
<br><br>
<p class="post-title" style="font-size: 44px; color:black; text-align:center;">Data BPN & Anggota</p>
<br><br>
<div class="row">
