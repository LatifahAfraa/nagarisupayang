        ...
        <div class="container-fluid h-100">
            <div class="row h-10 align-items-center">
                <div class="col-12 col-lg-8 mx-auto">
                    ...
                    <p class="post-title" style="font-size: 44px;">Penggunaan Dana Desa Nagari Supayang </p>
                    </div>
                </div>
            </div>
        </div>
...
<?php 			
    ...
    $result = mysqli_query($kon,"SELECT * FROM tb_rencana where namarencana = 'PENGGUNAAN DANA DESA'");
