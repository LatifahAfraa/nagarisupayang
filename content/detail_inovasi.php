            ...
            <div class="row h-10 align-items-center">
                <div class="col-12 col-lg-8 mx-auto">
                    ...
                    <div class="post-content text-center my-5">
                        <p class="post-title" style="font-size: 44px;">Kaba Inovasi Nagari Supayang</p>
                    </div>
                </div>
            </div>
        </div>
           ...
           <?php
                 ...
                 ?>
                             ...
                             <div class="blog-thumbnail">
                                 <a href="index.php?page=detail_inovasinagari&title=<?= $r['judul_seo'] ?>"><img src="admin/assets/images/<?= $r['gambar'] ?>" alt="amazing caves coverimage"  style="height: 200px; object-fit: cover;"></a>
                             </div>
     
                             <!-- Blog Content -->
                             <div class="blog-content">
                                 
                             <a href="index.php?page=detail_inovasinagari&title=<?= $r['judul_seo'] ?>" class="post-title"><?=substr(strip_tags($r['judul']),0,50);?></a>
                             ...
                             href="index.php?page=detail_inovasinagari&title=<?= $r['judul_seo'] ?>">
                             <button type="button" class="btn btn-danger" href="index.php?page=detail_inovasinagari&title=<?= $r['judul_seo'] ?>">selebihnya</button></a>
                             </div>
