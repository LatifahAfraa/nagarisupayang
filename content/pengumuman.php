            ...
            <div class="row h-10 align-items-center">
                <div class="col-12 col-lg-8 mx-auto">
                    ...
                    <div class="post-content text-center my-5">
                        <p class="post-title" style="font-size: 44px;"> PENGUMUMAN DAN HIMBUAN NAGARI SUPAYANG</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-blog-post style-2 mb-5">
                        ...
                        <div class="blog-content">
                            ...
                            <a href="index.php?page=detail_pengumummandanhimbauan&title=<?= $r['judul_seo'] ?>" class="post-title"><?=$r['judul'];?></a>
