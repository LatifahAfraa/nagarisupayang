<!-- ##### Post Details Title Area Start ##### -->
 <div class="post-details-title-area bg-overlay clearfix" style="background-image: url(img/bg-img/88.jpg); height: 16em">
            ...
            <div class="row h-10 align-items-center">
                <div class="col-12 col-lg-8 mx-auto">
                    ...
                    <div class="post-content text-center my-5">
                        <p class="post-title" style="font-size: 44px;">TOPOGRAFI NAGARI SUPAYANG</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php 			
    $result = mysqli_query($kon,"SELECT * FROM tb_profil where kategori = 'topografi'");
            ...
            <div class="row"> 
                <div class="col-lg-9 blog-post-single">
                    <div class="blog-item">
							...
							<div class="blog-desc">
								<ul align="justify"><?= $data['deskripsi']?></p>
							</div>							
						</div>
					</div>
