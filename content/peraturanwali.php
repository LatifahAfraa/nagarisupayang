...
<div class="post-details-title-area bg-overlay clearfix" style="background-image: url(img/bg-img/88.jpg); height: 16em">
            ...
            <div class="row h-10 align-items-center">
                <div class="col-12 col-lg-8 mx-auto">
                    ...
                    <div class="post-content text-center my-5">
                        <p class="post-title" style="font-size: 44px;">Peraturan Wali Nagari Dan Perangkat/Staff</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="top-news-area section-padding-100">
        <div class="container">
            ...
            <?php 			
                $result = mysqli_query($kon,"SELECT * FROM tb_peraturan where  jenis = 'peraturan wali nagari'");
