          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box box-info">
                ...
                <!-- form start -->
                <form method="POST" class="form-horizontal" action="kontak/igedit.php" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label for="des" class="col-sm-2 control-label">Nama Instagram</label>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          ...
                          <input type="hidden" name="idig" value=" <?= $_GET['idig'] ?> ">
                      ...
                      <div class="form-group">
                        <div class="col-sm-4 col-md-offset-2">
                          ...
                          <a href="?module=kontak/ignagari" class="btn btn-primary btn-flat">Kembali</a>
                        </div>
                      </div>
                    </div>
                </form>
