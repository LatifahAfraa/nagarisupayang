      ...
      case "tambahalamat":
        ...
        if (isset($_POST['save1'])) {
          ...
          if ($save) {
            ...
            window.location='?module=kontak/alamatnagari';
            </script>";
            exit;
          } else {
                  ...
                  <div class="box-body">
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label for="des" class="col-sm-2 control-label">Alamat Nagari</label>
                        <div class="col-sm-8">
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        <div class="col-sm-4 col-md-offset-2">
                          ...
                          <a href="?module=kontak/alamatnagari" class="btn btn-primary btn-flat">Kembali</a>
                        </div>
                      </div>
                    </div>
                </form>
          ...
          if ($del) {
            echo "<script>
                 alert('Data Berhasil Dihapus');
    					   window.location='index.php?module=kontak/alamatnagari';
    				  </script>";
          } else {
            echo "<script>
