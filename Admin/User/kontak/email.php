	...
	$save= mysqli_query($kon, "INSERT INTO email (idemail,email) VALUES ('','$_POST[email]')");
	 if($save) {
        echo "<script>
            ...
            window.location='?module=kontak/emailnagari';
            </script>";
            exit;
      }else{
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <div class="col-sm-4 col-md-offset-2">
					...
					<a href="?module=kontak/emailnagari" class="btn btn-primary btn-flat">Kembali</a>
                  </div>
                </div>
              </div>
            </form>
      ...
      if($del){
    	  echo "<script>
                 alert('Data Berhasil Dihapus');
    					   window.location='index.php?module=kontak/emailnagari';
    				  </script>";
      }else{
        echo "<script>
