        ...
        if (isset($_POST['save'])) {
          ...
          if ($save) {
            echo "<script>
                ...
                window.location='?module=informasi/event';
              </script>";
          } else {
                  ...
                  <div class="box-body ">
                    ...
                    <div class="form-group">
                      <div class="col-sm-4 col-md-offset-2">
                        ...
                        <a href="?module=informasi/event" class="btn btn-primary btn-flat">Kembali</a>
                      </div>
                    </div>
                  </div>
                </form>
          ...
          if ($del) {
            echo "<script>
                 alert('Data Berhasil Dihapus');
    					   window.location='index.php?module=informasi/event';
    				  </script>";
          } else {
            echo "<script>
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <a href="?module=informasi/event&aksi=tambahevent" class="btn btn-flat btn-primary">Tambah Event</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td><?= $r['jam'] ?></td>
                        <td><?= $r['status'] ?></td>
                        <td><a href="?module=informasi/event&aksi=editevent&id=<?= $r['idwaktu']; ?>" class="btn btn-success btn-flat">Edit</a>
                          <!-- <a href="?module=informasi/event&aksi=editevent&id=<? //= $r['idevent'];
                                                                                  ?>" class="btn btn-danger btn-flat" onclick="return confirm('Yakin Akan Menghapus Data Ini ... ?')">Hapus</a> -->
                        </td>
                      </tr>
                    <?php $no++;
                    } ?>
