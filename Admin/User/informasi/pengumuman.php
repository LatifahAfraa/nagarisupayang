          ...
          if ($save) {
            ...
            if ($jumlah > 0) {
              for ($i = 0; $i < $jumlah; $i++) {
                ...
                $nmfoto     = $file_name;
                move_uploaded_file($tmp_name, "../../asset/dokumen/" . $nmfoto);
            ...
            window.location='?module=informasi/pengumuman';
            </script>";
            exit;
          } else {
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        <div class="col-sm-4 col-md-offset-2">
                          ...
                          <a href="?module=informasi/pengumuman" class="btn btn-primary btn-flat">Kembali</a>
                        </div>
                      </div>
                    </div>
                </form>
      ...
      case "editpengumuman":
        ...
        if (isset($_POST['upload'])) {
          if (empty($_FILES['lampiran']['tmp_name'])) { ?>
            <script>
              window.alert('Berkas Belum di upload');
            </script>
        <?php
          } else {
                        ...
                        <table class="table table-bordered">
                          ...
                          ?>
                            <tr>
                              <td><?= $no ?></td>
                              <td><?= $rlamp['berkas'] ?></td>
                              <td><a href="?module=informasi/pengumuman&aksi=hapusberkas&id=<?= $rlamp['iddetailpengumuman'] ?>" class="btn btn-danger btn-xs"><i class="fa fa-close"></a></td>
                            </tr>
                          <?php } ?>
                        </table>
                      </div>
          ...
          if ($del) {
            echo "<script>
                 alert('Data Berhasil Dihapus');
    					   window.location='index.php?module=informasi/pengumuman';
    				  </script>";
          } else {
            echo "<script>
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <a href="?module=informasi/pengumuman&aksi=tambahpengumuman" class="btn btn-flat btn-primary">Tambah Informasi</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td><a href="?module=informasi/pengumuman&aksi=editpengumuman&id=<?= $r['idpengumuman']; ?>" class="btn btn-success btn-flat">Edit</a>
                          <a href="?module=informasi/pengumuman&aksi=hapuspengumuman&id=<?= $r['idpengumuman']; ?>" class="btn btn-danger btn-flat" onclick="return confirm('Yakin Akan Menghapus Data Ini ... ?')">Hapus</a>
                        </td>
                      </tr>
                    <?php $no++;
                    } ?>
