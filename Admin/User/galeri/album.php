      ...
      case "tambahalbum":
        ...
        if (isset($_POST['save1'])) {
          ...
          if ($save) {
            ...
            window.location='?module=galeri/albumbawaslu';
            </script>";
            exit;
          } else {
      ...
      case "editalbum":
        ...
        if (isset($_POST['save'])) {
          ...
          if (!empty($lokasi_file)) {
            ...
            unlink("../assets/images/" . $lihat['coveralbum']);
          } else {
                  ...
                  <div class="box-body">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        <label for="des" class="col-sm-2 control-label">Cover Album</label>
                        <div class="col-sm-8">
                        <img src="../assets/images/<?php echo $data['coverlbum'] ?>" width="200"></br><br>
                          <input name="fupload" id="fupload" type="file" class="form-control">
                      ...
                      <div class="form-group">
                        <div class="col-sm-4 col-md-offset-2">
                          ...
                          <a href="?module=galeri/albumbawaslu" class="btn btn-primary btn-flat">Kembali</a>
                        </div>
                      </div>
                    </div>
                </form>
          ...
          if ($del) {
            echo "<script>
                 alert('Data Berhasil Dihapus');
    					   window.location='index.php?module=galeri/albumbawaslu';
    				  </script>";
          } else {
            echo "<script>
